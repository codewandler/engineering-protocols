...
- **[Invoicing](domains/billing.invoice.md)** (`billing.invoice`) — Issuing invoices and tracking whether they are paid. Seven types, one entity, two views, four commands, four events, one error and two actors.
