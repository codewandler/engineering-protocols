...
//! | authored expectations | the specification itself | `infra-spec/1`, twelve kinds | [`trace-spec/1`](spec), forty-nine kinds |
...
//! | [`spec`] | the expectation vocabulary: forty-nine kinds, severity, and the `unk` policy |
